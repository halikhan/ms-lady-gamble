...
<body>
    ...
    style="height:100vh;width:60%;margin-left:auto;margin-right: auto;background-repeat: no-repeat;background-size: cover; background-image:  url({{$message->embed(asset('img/1x/emailimage.jpg'))}});">
       ...
       <tr>
        <th ><h1 style="font-family: Gobold;color: #f5a801;text-transform: capitalize; padding-top:220px;">Thank You MR <h2 style="font-family: Poppins-SemiBold;color: #fff;"> {{ $details->Username }}</h2> For Registration!<br>{{ $details->email }}</h1></th>
    </tr>

        <tr>
            <th><p style="font-family: Poppins-SemiBold;color: #fff;">We received it indeed! We've share it with the entire team, they were all very touched.
                <br>
