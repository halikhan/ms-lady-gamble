...
.homeMain .stepDiv .imgNo {
    margin-left: 0rem;
    text-align: left;
}
.homeMain .stepDiv .imgNo .stepp {
    font-size: 5vh;
    top: 37.5%;
    left: 8%;
}
.homeMain .stepDiv.step5 .sctImg img {
    width: 57%;
    margin-bottom: 8rem;
    margin-top: 0rem;
}
.homeMain .stepDiv.step2 .sctImg img {
    width: 57%;
    margin-bottom: 8rem;
    margin-top: 2rem;
}
.homeMain .stepDiv.step3 .sctImg img {
    width: 57%;
    margin-bottom: 6rem;
    margin-top: 0rem;
}
.homeMain .stepDiv.step1 .sctImg img {
    width: 50% ;
    margin-top: 1rem ;
    margin-bottom: 8rem;
}
.homeMain .stepDiv.step2::before, .homeMain .stepDiv.step4::before {
    top: 6%;
    right: 10%;
}
.homeMain .stepDiv.step4 .sctImg img {
    width: 50%;
    margin-right: 1rem;
    margin-bottom: 8rem;
    margin-top: 1rem;
...
.homeMain .stepDiv.step2 .sctImg, .homeMain .stepDiv.step4 .sctImg {
    text-align: right;
}
.homeMain .stepDiv.step4 .sctImg img {
    width: 50%;
...
<div class="homeMain">
    <div class="banner" style="height: 0px";>
        ...
        <div class="msLadyTab glowing" >
            ...
            {{-- <img src="{{asset('img/1x/the.png')}}" height="" width="100%" alt="" >
            <img src="{{asset('img/1x/lady.png')}}" height=" " width="100% " alt=" " >
            <img src="{{asset('img/1x/original.png')}}" height=""  alt="" >
    ...
    <div class="scrollSec mt2 ">
        <div class="stepDiv step1 " data-wow-delay="1s" data-wow-duration="1s">
          <div class="container-xxl ">
            <div class="row d-flex ">
              <div class=" fl-30 ">
                <div class="imgNo  ">
                  <img src="{{asset('img/1x/one.png')}}" height="100% " width="100% "alt=" " class="wow fadeInLeft">
                  <div class="stepp">
                    <span class="wow fadeInDown"  data-wow-delay="1s" data-wow-duration="1s">STEP</span>
                  </div>
                </div>
                <button class="playSignUp wow fadeInUp">SIGN UP THROUGH CHAT BOX</button>
              </div>
              <div class=" fl-70 ">
                <div class="sThro ">
                ...
                <div class="sctImg text-right ">
                  <img src="{{asset('img/banners/playOne.png')}}" height=" " width=" " alt=" " class="wow flipInY" data-wow-delay="0.75s" data-wow-duration="1s">
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="stepDiv step2" data-wow-delay="1s" data-wow-duration="1s">
          <div class="container-xxl ">
            <div class="row d-flex ">
                <div class=" fl-70 ">
                    <div class="sThro ">
                    ...
                    <div class="sctImg text-right ">
                      <img src="{{asset('img/banners/playTwo.png')}}" height=" " width=" " alt=" " class="wow flipInY" data-wow-delay="0.75s" data-wow-duration="1s">
                    </div>
                  </div>
              <div class=" fl-30 ">
                <div class="imgNo  ">
                  <img src="{{asset('img/1x/two.png')}}" height="100% " width="100% " alt=" " class="wow fadeInRight"  data-wow-delay="1s" data-wow-duration="1s">
                  <div class="stepp">
                    <span class="wow fadeInDown"  data-wow-delay="1s" data-wow-duration="1s">STEP</span>
                  </div>
                </div>
                <button class="playSignUp wow fadeInUp">GET YOUR ACCOUNT</button>
              </div>
        ...
        <div class="stepDiv step3 " data-wow-delay="1s" data-wow-duration="1s">
          <div class="container-xxl ">
            <div class="row d-flex ">
              <div class=" fl-30 ">
                <div class="imgNo  ">
                ...
                <button class="playSignUp wow fadeInUp">BUY YOUR COINS FROM US</button>
              </div>
              <div class=" fl-70 ">
                <div class="sThro ">
                ...
                <div class="sctImg text-right ">
                  <img src="{{asset('img/banners/playThree.png')}}" height=" " width=" " alt="" class="wow flipInY" data-wow-delay="0.75s" data-wow-duration="1s">
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="stepDiv step4 " data-wow-delay="1s" data-wow-duration="1s">
          <div class="container-xxl ">
            <div class="row d-flex ">
              ...
              <div class=" fl-70 ">
                ...
                <div class="sctImg text-right ">
                  <img src="{{asset('img/banners/playFour.png')}}" height=" " width=" " alt=" " class="wow flipInY" data-wow-delay="0.75s" data-wow-duration="1s">
                </div>
              </div>
                <div class=" fl-30 ">
                <div class="imgNo  ">
                  <img src="{{asset('img/1x/four.png')}}" height="100% " width="100% "alt=" " class="wow fadeInRight"  data-wow-delay="1s" data-wow-duration="1s">
                  <div class="stepp">
                    <span class="wow fadeInDown"  data-wow-delay="1s" data-wow-duration="1s">STEP</span>
                  </div>
                </div>
                <button class="playSignUp wow fadeInUp">PLAY AND WIN</button>
              </div>
            </div>
          </div>
        </div>

        <div class="stepDiv step5 " data-wow-delay="1s" data-wow-duration="1s">
          <div class="container-xxl ">
            <div class="row d-flex ">
              <div class=" fl-30 ">
                <div class="imgNo  ">
                ...
                <button class="playSignUp wow fadeInUp">REDEEM YOUR WINNINGS</button>
              </div>
              <div class=" fl-70 ">
                <div class="sThro ">
                ...
                <div class="sctImg text-right ">
                  <img src="{{asset('img/banners/playFive.png')}}" height=" " width=" " alt=" " class="wow flipInY" data-wow-delay="0.75s" data-wow-duration="1s">
                </div>
              </div>
            </div>
          </div>
