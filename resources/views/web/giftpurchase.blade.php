                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-left gold-color" style="padding: 15px;
                                                ...
                                                font-size: 18px">Gift Card Name</th>
                                    ...
                                    <th class="text-right gold-color" style="padding: 15px;
                                                ...
                                                white-space: nowrap;
                                                font-weight: 800;color: #916501;
                                                font-size: 18px">Card Number or Link</th>
                                    <th class="text-right gold-color" style="padding: 15px;
                                                background: #eee;
                                                border-bottom: 1px solid #fff;
                                                white-space: nowrap;
                                                font-weight: 800;color: #916501;
                                                font-size: 18px">serial_number or Pin Code</th>
                                </tr>
                            </thead>
                            <tbody>
                                @foreach ($details['gifts'] as $gift )
                                ...
                                <tr>
                                    ...
                                    <td class="qty" style="text-align:
                                                ...
                                                #fff ;
                                                text-align:center;
                                                font-size: 1.2em"> {{$gift->serial_number ?? " "}}
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
                            <tfoot>
                                <tr>
                                    ...
                                    <td style="background: 0 0; border-bottom: none; white-space: nowrap; text-align: right; padding: 30px 20px; color: #916501; font-weight: 700; border-top: 1px solid #aaa; color: #916501; font-size:
                                        1.4em; border-top: 1px solid #916501 "> $ {{Session::get('total-amount')}}</td>
                                </tr>
                            </tfoot>
                        </table>
                        <div class="thanks "
