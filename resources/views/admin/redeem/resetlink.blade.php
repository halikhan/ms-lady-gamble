...
<body>
    <table class="for-blur-background"
        ...
        <tr>
            <th>
                <h1 style="font-family: Gobold;color: #f5a801;text-transform: capitalize; padding-top:220px;">Here is
                    your Redeem discription</h1>
            </th>
        </tr>
        ...
        <tr>
            <td align="center">
                ...
                <h3 style="font-family: Gobold;color: #f5a801;text-transform: capitalize;">
                    {{ Auth::user()->first_name }}</h3><br>
                <b style="font-family: Poppins-SemiBold;color: #ffffff;">Last Name:</b>
                <h3 style="font-family: Gobold;color: #f5a801;text-transform: capitalize; ">
                    {{ Auth::user()->last_name }}</h3><br>
                {{-- <b>Pin Code:</b><br> --}}
                <b style="font-family: Poppins-SemiBold;color: #ffffff;">Pin Code:</b>
                <h3 style="font-family: Gobold;color: #f5a801;text-transform: capitalize;">{{ $details->pin_code }}</h3>
                <br>
