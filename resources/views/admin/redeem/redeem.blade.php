    ...
    <img src="{{ asset('img/1x/Preloader.gif') }}" alt="processing..." />
            ...
            <div class="card-body">
                <div class="col-md-12" style="overflow-x:auto;">
                    <table id="example_data" class="table table-striped table-bordered"  role="grid" aria-describedby="example1_info">
                        <thead>
                            <tr role="row">
                                ...
                                <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Email Address: activate to sort column ascending">#</th>
                                <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Email Address: activate to sort column ascending">Coins</th>
                                <th class="sorting" tabindex="1" aria-controls="example1" rowspan="1" colspan="1" aria-label="Registration Date: activate to sort column ascending" width="200">Amount Request</th>
                                <th class="sorting" tabindex="1" aria-controls="example1" rowspan="1" colspan="1" aria-label="Registration Date: activate to sort column ascending" width="200">Status</th>
                                <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Baskets: activate to sort column ascending">Date/Time</th>
                        ...
                        <tbody>
                            ...
                            <tr role="row" class="odd">
                                ...
                                <td>{{$key+1}}</td>
                                <td class="{{'name'.$withdraw_list->id}}">{{$withdraw_list->bit_coin_wallet ?? '-'}}</td>
                                {{-- <td class="{{'last_name'.$withdraw_list->id}}">{{$withdraw_list->user->basicInfo->bitcoin_wallet_address ?? '-'}}</td> --}}
                                <td class="{{'last_name'.$withdraw_list->id}}">{{$withdraw_list->amount_request ?? '-'}}</td>
                                <!-- email -->
                                ...
                                @endif
                                <td class="{{'last_name'.$withdraw_list->id}}">{{date("m/d/y g:i A", strtotime($withdraw_list->created_at)) ?? '-'}}</td>

                                <td class='d-flex align-items-center justify-content-around'>
                            <button type="button" class="btn btn-default" data-toggle="modal" data-target="#status_update{{$withdraw_list->id}}"><i class="fas fa-edit  admin-icons"></i></button>
                                    <i class="fa fa-eye  admin-icons" data-toggle="modal" data-target="#view_details{{$withdraw_list->id}}"></i>
                            ...
                            <div class="modal fade" id="view_details{{$withdraw_list->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        ...
                                        <div class="modal-body">
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    ...
                                                    {{$withdraw_list->user->first_name ?? '-'}} {{$withdraw_list->user->last_name ?? '-'}}
                                                </div>

                                                <div class="col-sm-6">
                                                    <label>Coins:</label> {{$withdraw_list->bit_coin_wallet}}
                                                </div>
                                                {{-- <div class="col-sm-6">
                                ...
                                <div class="modal fade" id="status_update{{$withdraw_list->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel">Withdraw Request</h5>
                                            ...
                                            <div class="modal-body">
                                            <form action="{{ route('redeem_action', ['id' => $withdraw_list->id]) }}" id="myform" onsubmit="return transaction_id()">
                                                <div class="row">
                                                    <div class="col-sm-6 d-flex flex-column">
                                                        <label>STATUS:</label>
                                                        <label class="form-control">@if ($withdraw_list->status == 1)
                                                            Approved
                                                            @else
                                                            Pending
                                                            @endif </label>
