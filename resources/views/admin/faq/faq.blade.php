...
<div class="row mb-2">
  <div class="col-sm-6">
    <h1 class="m-0 text-dark"><i class="nav-icon fas fa-text-width"></i> FAQs</h1>
  </div>
</div>
                ...
                @foreach($faqs as $key => $article)
                  <tr role="row" class="odd">
                    ...
                    <td width="100">
                        ...
                        <!-- Edit -->
                        <a href="{{route('faq.show',$article->id)}}">
                    ...
                    {{-- modal --}}
                  <div class="modal fade" id="test{{$article->id}}" tabindex="-1" role="dialog" aria-labelledby="editArticleModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered modal-lg">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h5 class="modal-title" id="editArticleModalLabel">Edit FAQs</h5>
                        ...
                        <form id="editForm" method="POST" action="{{route('article.update', 1)}}" enctype="multipart/form-data">
                          <!-- hidden input -->
                          @method('PUT')
                          <input id="hidden" type="hidden" name="hidden" value="{{$article->id}}">
                          @csrf
                          ...
                          <div class="modal-body row">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <textarea type="text" name="question" placeholder="Question"  class="form-control content">{{$article->question}}</textarea>
                            </div>
                            <!-- link -->
                            <div class="form-group col-md-12 col-sm-3">
                                <label>Answer:</label>
                                <textarea type="text" name="answer" id="editor2" placeholder="Answer"  class="form-control" required>{!!$article->answer !!}</textarea>
                            </div>
                        </div>
  ...
  <div class="modal-dialog modal-dialog-centered modal-lg">
    <div class="modal-content">
      ...
      <form method="POST" action="{{route('faq.store')}}" enctype="multipart/form-data">
        ...
        @include('admin.faq.faq_master')
        <div class="modal-footer">
          <button type="submit" class="btn btn-primary mailregister">Create</button>
        </div>
      </form>
    </div>
  </div>
