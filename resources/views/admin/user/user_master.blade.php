...
{{-- immage --}}
    ...
    <div class="form-group col-md-6">
        ...
        class="form-control email" max="50"  required>
    </div>
    {{-- <div class="form-group col-md-6">
        <label for="">User Free Credit</label>
        <input type="text" autocomplete="off" name="user_wallet" placeholder="User Free Credit"
        class="form-control user_wallet" max="50">
    </div> --}}
    <!-- password -->
    <div class="form-group col-md-6">
    <label for="">Password</label>
    <input type="password" name="password" placeholder="Enter password"
    class="form-control password" min=4 required>
    </div>
</div>
